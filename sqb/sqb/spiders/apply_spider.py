...
from sqb.urls import get_apply
from bs4 import BeautifulSoup as soup

class ApplySpider(CrawlSpider):
	name = 'apply'
	url_dict_list = get_apply()
	...
	def parse_list(self, response):
		'''
			...
			in the node of form <a href=sss"..." title="..."> which 
			indicates that this is a apply info page, since it has
			a title.
		'''
		html = response.body
